...
interface ILssGovernance {
    ...
    //added below: refundContractAddressForInvalidVotes
    function refundContractAddressForInvalidVotes(uint256 _reportId) external;
    //added above
    ...
    //added below
    event refundSingleContract(address indexed _wallet, uint256 indexed _amount);
    event refundDoubleContract(address indexed _wallet1,address indexed _wallet2, uint256 indexed _amount1, uint256 _amount2);
    //added above
